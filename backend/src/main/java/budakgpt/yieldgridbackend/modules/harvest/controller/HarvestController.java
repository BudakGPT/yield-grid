package budakgpt.yieldgridbackend.modules.harvest.controller;
...
public class HarvestController {
    ...
    public ApiResponse<String> health() {
        return ApiResponse.success("Harvest module ready");
    }

    @PostMapping
    public ApiResponse<String> createPlaceholder() {
        return ApiResponse.success("TODO: implement Harvest endpoint");
    }
}
